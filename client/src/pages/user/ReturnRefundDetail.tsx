...
import ReturnItem from "../../components/user/purchase/ReturnItem";
import HowToPackModal from "../../components/user/modal/HowToPackModal";
import toast from "react-hot-toast";
import jsPDF from "jspdf";
import html2canvas from "html2canvas";
import ReturnLabelHtml from "../../components/user/pdf/ReturnLabelHtml";
import ConfirmSubmitModal from "../../components/user/modal/ConfirmSubmitModal";
import PurchaseDetailSkeleton from "../../components/user/skeleton/PurchaseDetailSkeleton";
          ...
          {states.map((state, idx) => {
            ...
            return (
              ...
              >
                ...
                <p className="mt-2 mb-0 text-capitalize">{state.name}</p>
                {createdAt && (
        ...
        <>
          ...
          <div>
            ...
            <p className="mb-1 text-capitalize">
              Reason: {returnDetail.reason.name}
            </p>
