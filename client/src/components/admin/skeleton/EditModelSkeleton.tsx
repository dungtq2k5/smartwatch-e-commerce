        ...
        <div className="col-lg-8">
          ...
          <div className="card shadow-sm mb-4">
            ...
            <div className="card-body">
              <div className="mb-3">
                 <Placeholder xs={12} style={{ height: "38px", marginTop: "24px" }} />
              </div>
              <div className="row">
              ...
              <div className="row">
                 <div className="col-md-4 mb-3"><Placeholder xs={12} style={{ height: "38px", marginTop: "24px" }} /></div>
                 <div className="col-md-4 mb-3"><Placeholder xs={12} style={{ height: "38px", marginTop: "24px" }} /></div>
                 <div className="col-md-4 mb-3"><Placeholder xs={12} style={{ height: "38px", marginTop: "24px" }} /></div>
              </div>
               <div className="mb-3">
...
export default EditModelSkeleton;
