          ...
          <div className="d-flex flex-column gap-4">
            ...
            <div className="card shadow-sm">
              <div className="card-header bg-white py-3">
                <h2 className="h5 mb-0 placeholder col-4"></h2>
              </div>
              <div className="card-body">
                <div className="card mb-3">
                  <div className="card-body">
                    <div className="d-flex gap-3">
                      <div className="placeholder purchase-item-img--g rounded"></div>
                      <div className="flex-grow-1">
                        <p className="fw-semibold mb-1 placeholder col-10"></p>
                        <div className="small text-muted mb-2 placeholder col-5"></div>
                        <div className="form-check">
                          <span className="form-check-input placeholder"></span>
                          <label className="form-check-label placeholder col-7"></label>
                        </div>
                      </div>
                    </div>
                  </div>
