...
import { useWithdrawalStateStore } from "../../store/withdrawalRequest/withdrawalStateStore";
import type {
  SelfWithdrawalRequestResponse,
  WithdrawalStateResponse,
} from "../../../../common/types.common";
import { useUserWithdrawalRequestStore } from "../../store/withdrawalRequest/userWithdrawalRequestStore";
              ...
              <>
                ...
                <div className="text-center border-bottom pb-3 mb-4">
                  ...
                  <p className="text-success mb-0 fs-5">
                    Transaction {capFirstLetter(requestState.name)}
                  </p>
                </div>
