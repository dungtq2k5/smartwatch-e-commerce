...
export const LOOKUP_ID = {
  ...
  IVT_MOVEMENT_TYPE: {
    ...
    STOCK_TRANSFER: "5",
    DAMAGED_STOCK: "6",
    RETURN_TO_SUPPLIER: "7",
    RETURN_FROM_CUSTOMER: "8",
    STOCK_AUDIT: "9",
    OTHER: "10",
  },
  DELIVERY_STATE: {
  ...
  REFUND_STATE: {
    PENDING: "1",
    REFUNDED_VIA_STRIPE: "2",
    REFUNDED_TO_BALANCE: "3",
    REFUND_VIA_STRIPE_FAILED: "4",
  },
  RETURN_STATE: {
    PENDING_APPROVAL: "1",
    APPROVED: "2",
  ...
  PICKUP_STATE: {
    ...
    OUT_FOR_PICKUP: "2",
    PICKED_UP: "3",
    IN_TRANSIT_TO_WAREHOUSE: "4",
    RETURNED_TO_WAREHOUSE: "5",
    PICKUP_FAILED: "6",
    PICKUP_RESCHEDULED: "7",
  },
  WITHDRAWAL_STATE: {
    PENDING: "1",
    APPROVED: "2",
